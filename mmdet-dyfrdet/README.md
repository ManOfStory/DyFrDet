...
```shell script
conda create -n dyfrdet python=3.8
...
git clone https://github.com/jwwangchn/cocoapi-aitod.git
...
"/xxx/envs/dyfrdet/lib/python3.8/site-packages/mmcv/runner/epoch_based_runner.py"
